...
class TestAsyncStreamStreamCentric : public ::testing::TestWithParam<std::tuple<bool,uint_t>> {};
...
TEST_P(TestAsyncStreamStreamCentric, orderedSequence) {
    ...
    AsyncStream<CounterStream, uint_t> asyncStream(counterStream, true, block_size);
...
INSTANTIATE_TEST_CASE_P(TestAsyncStreamStreamCentricLengths,
    ...
    ::testing::Combine(::testing::Bool(), ::testing::Values(0, 1, 2<<16, 2 << 20)));
