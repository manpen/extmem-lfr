...
int main(int argc, char** argv) {
  ...
  degree_sequence* dd = new degree_sequence(Fdeg, !RAW_DEGREES);
...
int parse_options(int &argc, char** &argv) {
  ...
  for(int a=1; a<argc0; a++) {
    ...
    else if(strcmp(argv[a],"-d")==0) SHUFFLE_TYPE = DISCONNECTED;
  ...
  if(HELP || argc!=1) {
    ...
    fprintf(stderr,"    [-d] option produces possibly disconnected graphs.\n");
