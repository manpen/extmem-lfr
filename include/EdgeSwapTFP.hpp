...
// dependency chain
   struct DependencyChainEdgeMsg : TupleSortable {
      swapid_t swap_id;
      edgeid_t edge_id;
      edge_t edge;
      ...
      DECL_LEX_COMPARE(DependencyChainEdgeMsg, swap_id, edge_id, edge);
   };

   struct DependencyChainSuccessorMsg : TupleSortable {
      swapid_t swap_id;
      edgeid_t edge_id;
      swapid_t successor;
      ...
      DECL_LEX_COMPARE(DependencyChainSuccessorMsg, swap_id, edge_id, successor);
   };
...
// existence requests
   struct ExistenceRequestMsg : TupleSortable {
      edge_t edge;
      swapid_t swap_id;
      ...
      DECL_LEX_COMPARE(ExistenceRequestMsg, edge, swap_id);
   };
...
// existence information and dependencies
   struct ExistenceInfoMsg : TupleSortable {
      swapid_t swap_id;
      swapid_t sender_id;
      edge_t edge;
      bool exists;
      ...
      DECL_LEX_COMPARE(ExistenceInfoMsg, swap_id, sender_id, edge, exists);
   };
   ...
   struct ExistenceSuccessorMsg : TupleSortable {
      swapid_t swap_id;
      edge_t edge;
      swapid_t successor;
      ...
      DECL_LEX_COMPARE(ExistenceSuccessorMsg, swap_id, edge, successor);
   };
...
// edge updates
   struct EdgeUpdateMsg : TupleSortable {
      edgeid_t edge_id;
      swapid_t sender;
      edge_t updated_edge;
      ...
      DECL_LEX_COMPARE(EdgeUpdateMsg, edge_id, sender, updated_edge);
   };
